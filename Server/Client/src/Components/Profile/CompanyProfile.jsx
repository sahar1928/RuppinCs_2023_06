...
const CompanyProfile = ({ user }) => {
  ...
  const { LinkedinURL, TwitterURL, FacebookURL, PinterestURL, InstagramURL } =
    SocialMedia;
        ...
        <div className="row">
              ...
              <div className="jm-candidate-profile-overview-portion">
                ...
                <div className="jm-candidate-profile-buttons mt-25">
                  <Link to="#" className="jm-candidate-d-btn">
                    <i className="fa-thin fa-phone"></i>Contact Us
                  </Link>
                </div>
              </div>
              <div className="jm-candidate-profile-overview-portion">
                ...
                <ul className="jm-job-sidebar-working-daylist">
                  <li>
                    <span className="jm-job-working-daylist-label">
                      Saturday :{" "}
                    </span>{" "}
                    <span className="jm-job-working-daylist-value">
                      10am - 6pm
                    </span>
                  </li>
                  <li>
          ...
          <div className="col-lg-8 order-0 order-lg-1">
            <div className="jm-company-offer-jobs">
              <h4 className="jm-company-offer-title">
                Current Offering Positions
              </h4>
